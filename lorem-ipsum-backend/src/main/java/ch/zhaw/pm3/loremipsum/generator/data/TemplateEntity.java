...
/**
 * Entity fuer die abbildung von Template.
 */
@Getter
@Setter
...
public class TemplateEntity {
    ...
    private List<RowConfigurationEntity> rowTemplateEntities;
    ...
    public List<RowConfigurationEntity> getRowTemplateEntities() {
